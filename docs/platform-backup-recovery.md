...
7. kör den samlade körgrinden `supabase/production-preflight-all.sql`, radantals-/integritetskontroller och autentiserad smoke mot en verklig återställd testgrupp; aggregate-filen inkluderar baspreflighten och samtliga obligatoriska fokuserade preflights;
