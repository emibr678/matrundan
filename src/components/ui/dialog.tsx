...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, overlayClassName, forceMount, ...props }, ref) => (
  <DialogPortal forceMount={forceMount}>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-[calc(100vw-1rem)] max-w-lg max-h-[calc(100dvh-1rem)] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-x-hidden overflow-y-auto border bg-background p-4 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:max-h-[90vh] sm:p-6 sm:rounded-lg",
        className,
      )}
      {...props}
    >
