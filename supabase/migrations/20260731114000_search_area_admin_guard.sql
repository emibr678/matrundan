...
-- Blockera nya breda administrativa områden i punkt + radie-modellen.
-- Befintliga rader får sparas oförändrade så att användaren kan byta ut dem
-- utan att andra gruppinställningar låses eller data raderas automatiskt.
