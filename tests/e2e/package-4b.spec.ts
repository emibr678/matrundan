...
test("demo-läget samlar lokala gruppinställningar utan livegruppens statuskontroller", async ({
  page,
}) => {
  ...
  await expect(settings.getByRole("button", { name: /Om Matrundan/ })).toHaveCount(0);
